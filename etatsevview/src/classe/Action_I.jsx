...
export class Action_I extends Component{
    ...
    setMariage(){
        ...
        this.state.famille.NumRegistre=2;
    ...
    setDeces(){
        ...
        this.state.Pdeath.NumRegistre=3;
        ...
        <div className="modal-body">
            ...
            <h3 className='text-center'>Nouveau Ne</h3>
                ...
                <div className="input-group mb-3">
                    ...
                    <input type="text" placeholder='Pays' className="form-control"value={P.Pays_Naissance}onChange={this.changePays_de_Naissance}/>
                </div>
                <div className="input-group mb-3">
